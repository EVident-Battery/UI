...
from PyQt5.QtWidgets import (
    QApplication, QMainWindow, QWidget, QComboBox, QPushButton, QHBoxLayout, 
    QVBoxLayout, QLabel, QLineEdit, QFileDialog, QProgressBar, QMessageBox, 
    QFrame, QGraphicsDropShadowEffect, QSizePolicy, QScrollArea, QDialog, 
    QTextEdit, QRadioButton, QButtonGroup, QGroupBox
)
from PyQt5.QtCore import Qt, QTimer, pyqtSignal, QObject, QEvent
from PyQt5.QtGui import QColor, QPixmap, QPainter, QIntValidator, QDoubleValidator
...
# Custom event for updating shaker battery
